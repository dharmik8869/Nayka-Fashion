...
function displayProductDetails() {
    ...
    if (!product) {
        document.getElementById('productDetails').innerHTML = `
            <div class="col-12 text-center">
                ...
                <a href="women-products.html" class="btn btn-primary">Back to Women's Products</a>
            </div>
        `;
        return;
    }
    ...
    const productDetailsHTML = `
        ...
        <div class="col-md-6">
            ...
            <div class="mb-4">
                <h5>Description</h5>
                <p>This is a beautiful ${product.name} designed for women. Made with high-quality materials, this piece combines elegance and comfort perfectly.</p>
            </div>
            <div class="mb-4">
                <h5>Features</h5>
